...
$(document).ready(function() {
    var e = '<div class="prt_floting_customsett">'+
                '<a href="https://www.facebook.com/soyabonchi/" target="_blank" class="tmtheme_fbar_icons"><i class="fa fa-facebook"></i></a>'+
                '<a href="https://t.me/erkinov_8360" target="_blank" class="tmtheme_fbar_icons"><i class="fa fa-telegram" aria-hidden="true"></i></a>'+
                '<a href="tel:+998 91 135-00-71" target="_blank" class="tmtheme_fbar_icons"><i class="fa fa-phone" aria-hidden="true"></i></a>'+
