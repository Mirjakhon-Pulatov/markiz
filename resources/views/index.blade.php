...
@section('content')
        ...
        <div id="rev_slider_4_1" class="rev_slider fullwidthabanner" data-version="5.4.8.1">
            <ul>
                <li data-index="rs-3" data-transition="slotslide-horizontal" data-slotamount="default"
                    ...
                    <img src="{{ asset('public/asset/images/slides/slider-mainbg-001.jpg') }}" alt="" title="slider-mainbg-001"
                         data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"
                         class="rev-slidebg" data-no-retina="">

                    <div class="tp-caption tp-resizeme" id="slide-3-layer-1"
                         data-x="['left','left','center','center']" data-hoffset="['50','40','0','0']"
                         data-y="['top','top','middle','middle']" data-voffset="['169','179','-136','-86']"
                         data-fontsize="['18','18','15','12']" data-lineheight="['20','20','20','15']"
                    ...
                    <div class="tp-caption tp-resizeme" id="slide-3-layer-2"
                         data-x="['left','left','center','center']" data-hoffset="['49','39','0','0']"
                         data-y="['top','top','middle','middle']" data-voffset="['189','199','-83','-44']"
                         data-fontsize="['75','75','60','40']" data-lineheight="['100','100','80','50']"
                         ...
                         data-textalign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]"
                         data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]">
                        Best <strong class="ttm-textcolor-skincolor">Handyman</strong></div>

                    <div class="tp-caption tp-resizeme" id="slide-3-layer-3"
                         data-x="['left','left','center','center']" data-hoffset="['50','40','0','0']"
                         data-y="['top','top','top','top']" data-voffset="['271','281','170','156']"
                         data-fontsize="['75','75','60','40']" data-lineheight="['100','100','80','50']"
                         data-fontweight="['600','600','600','600']"
                         data-color="['rgb(242, 244, 248)','rgb(242, 244, 248)','rgb(242, 244, 248)','rgb(242, 244, 248)']"
                         data-width="none" data-height="none" data-whitespace="nowrap" data-type="text"
                    ...
                    <div class="tp-caption tp-resizeme" id="slide-3-layer-4"
                         data-x="['left','left','center','center']" data-hoffset="['50','40','-142','-473']"
                         data-y="['top','top','middle','middle']" data-voffset="['379','389','44','76']"
                         data-fontsize="['22','22','19','19']" data-lineheight="['30','30','25','25']"
                         data-color="['rgb(242, 244, 248)','rgb(242, 244, 248)','rgb(242, 244, 248)','rgb(242, 244, 248)']"
                    ...
                    <div class="tp-caption tp-shape tp-shapewrapper tp-resizeme" id="slide-3-layer-5"
                         ...
                         data-y="['top','top','middle','middle']" data-voffset="['390','400','46','42']"
                         data-width="10" data-height="10" data-borderradius="100" data-whitespace="nowrap"
                    ...
                    <div class="tp-caption tp-resizeme" id="slide-3-layer-6"
                         data-x="['left','left','center','center']" data-hoffset="['231','221','0','-531']"
                         data-y="['top','top','middle','middle']" data-voffset="['379','389','45','118']"
                         data-fontsize="['22','22','19','19']" data-lineheight="['30','30','25','25']"
                         data-color="['rgb(242, 244, 248)','rgb(242, 244, 248)','rgb(242, 244, 248)','rgb(242, 244, 248)']"
                         data-width="none" data-height="none" data-whitespace="nowrap"
                         data-visibility="['on','on','on','off']" data-type="text" data-responsive_offset="on"
                    ...
                    <div class="tp-caption tp-resizeme" id="slide-3-layer-7"
                         data-x="['left','left','center','center']" data-hoffset="['382','372','125','-566']"
                         data-y="['top','top','middle','middle']" data-voffset="['379','389','45','59']"
                         data-fontsize="['22','22','19','19']" data-lineheight="['30','30','25','25']"
                         data-color="['rgb(242, 244, 248)','rgb(242, 244, 248)','rgb(242, 244, 248)','rgb(242, 244, 248)']"
                         data-width="none" data-height="none" data-whitespace="nowrap"
                         data-visibility="['on','on','on','off']" data-type="text" data-responsive_offset="on"
                    ...
                    <a class="tp-caption skin-flat-button tp-resizeme" href="#" target="_self" id="slide-3-layer-9"
                       data-x="['left','left','center','center']" data-hoffset="['50','40','0','0']"
                       data-y="['top','top','middle','middle']" data-voffset="['452','462','121','69']"
                ...
                <li data-index="rs-4" data-transition="slotslide-horizontal" data-slotamount="default"
                    ...
                    <img src="{{ asset('public/asset/images/slides/slider-mainbg-002.jpg') }}" alt="" title="slider-mainbg-002"
                         data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"
                         class="rev-slidebg" data-no-retina="">
                    ...
                    <div class="tp-caption tp-resizeme" id="slide-4-layer-2"
                        ...
                        Are <strong class="ttm-textcolor-skincolor">Always</strong></div>
                    ...
                    <div class="tp-caption tp-resizeme ttm-textcolor-skincolor" id="slide-4-layer-12"
                         ...
                         data-fontsize="['31','31','32','22']" data-lineheight="['40','40','40','30']"
                         data-width="none" data-height="none" data-whitespace="nowrap" data-type="text"
                         data-responsive_offset="on"
                    ...
                    <a class="tp-caption skin-flat-button tp-resizeme" href="#" target="_self" id="slide-4-layer-9"
                       data-x="['right','right','center','center']" data-hoffset="['50','40','0','0']"
                       data-y="['top','top','middle','middle']" data-voffset="['454','467','153','115']"
                       data-fontsize="['13','13','12','11']" data-lineheight="['13','13','12','11']"
                       data-width="none" data-height="none" data-whitespace="nowrap" data-type="text"
                       data-actions='' data-responsive_offset="on"
                       ...
                       data-textalign="['inherit','inherit','inherit','inherit']" data-paddingtop="[20,20,15,12]"
                       data-paddingright="[30,30,25,20]" data-paddingbottom="[20,20,15,12]"
                       data-paddingleft="[30,30,25,20]">VIEW PORTFOLIO </a>
    ...
    <div class="site-main">
                            ...
                            <div class="row row-equal-height ttm-bgcolor-white box-shadow2">
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    ...
                                    <div class="featured-icon-box style1 top-icon text-center">
                                        <div
                                            class="ttm-icon ttm-icon_element-fill ttm-icon_element-background-color-skincolor ttm-icon_element-size-md ttm-icon_element-style-square">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 box-shadow2">
                                    ...
                                    <div class="featured-icon-box style1 top-icon text-center">
                                        ...
                                        <div class="featured-content">
                                            ...
                                            <div class="featured-desc">
                                                <p>We work to ensure people’s comfort at their home to provide the
                                                    best and the fastest.</p>
                                                <a class="ttm-btn ttm-btn-size-sm ttm-icon-btn-right ttm-btn-color-skincolor btn-inline mb-15"
                                                   href="#">MORE ABOUT<i class="ti ti-angle-double-right"></i></a>
                                            </div>
                                        </div>
                                    </div><!-- featured-icon-box end-->
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    ...
                                    <div class="featured-icon-box style1 top-icon text-center">
                                        ...
                                        <div class="featured-content">
                                            ...
                                            <div class="featured-desc">
                                                <p>We have been working for years to improve our skills, to expand
                                                    the spheres of our work.</p>
                                                <a class="ttm-btn ttm-btn-size-sm ttm-icon-btn-right ttm-btn-color-skincolor btn-inline mb-15"
                ...
                <div class="row">
                    <div class="col-md-5 col-sm-12">
                        ...
                        <div class="ttm_single_image-wrapper mb-35">
                            <img class="img-fluid" src="{{ asset('public/asset/images/single-img-one.png') }}" alt="">
                        ...
                        <div class="pr-10 res-991-plr-0">
                            ...
                            <div class="section-title clearfix">
                                <div class="title-header">
                                    <h5>ABOUT1 BOLDMAN</h5>
                                    <h2 class="title">We Build for Your Comfort</h2>
                                </div>
                            </div><!-- section title end -->
                            <p><strong>We are a team of professional and skilled experts in all domestic spheres. We
                                    offer a wide range of services and at the same time we are always glad to help
                                    you with any unconventional household needs:</strong></p>
                            <p class="pt-10 pb-10">We work to ensure people’s comfort at their home, and to provide
                                the best and the fastest help at fair prices. We stand for quality, safety and
                                credibility, so you could be sure about our work. Initially we started as a company
                                specializing in household maintenance. During our successful work we expanded our
                                list of services. Now we are proud that we can help people with welding, moving, dry
                                cleaning, landscaping and even pest control. Every member of our team is indeed good
                                at his job and the company guarantees the quality of work.
                            </p>
            ...
            <div class="container">
                ...
                <div class="row">
                        ...
                        <div
                            ...
                            <div class="layer-content">
                                ...
                                <div class="section-title with-desc mb-40 clearfix">
                                    ...
                                    <div class="title-desc">Boldman has 10+ years of experience with providing wide
                                ...
                                <div class="featured-icon-box style3 left-icon icon-align-top">
                                    ...
                                    <div class="featured-content">
                                        ...
                                        <div class="featured-desc">
                                            <p>We have experience in home maintenance any surface from new
                                                constructions to cabinets in commercial properties. If you are doing
                                                your</p>
                                        </div>
                                    </div>
                                </div><!-- featured-icon-box end-->
                                ...
                                <div class="featured-icon-box style3 left-icon icon-align-top">
                                    ...
                                    <div class="featured-content">
                                        ...
                                        <div class="featured-desc">
                                            <p>Electricity is very important part of our life. We can’t imagine it
                                                without home appliances that in turns work with services provider
                                            </p>
                                        </div>
                                    </div>
                                </div><!-- featured-icon-box end-->
                    ...
                    <div class="col-lg-6">
                        ...
                        <img src="{{ asset('public/asset/images/bg-image/col-bgimage-1.jpg') }}" class="ttm-equal-height-image" alt="bg-image">
                    </div>
                </div><!-- row end -->
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <div class="ttm_single_image-wrapper mb_60 res-991-mb-0 res-991-mt-50">
                            <img class="img-fluid" src="{{ asset('public/asset/images/single-img-twel.jpg') }}" alt="">
                        </div><!-- ttm_single_image-wrapper end -->
                    </div>
                    <div class="col-md-7">
                        <div class="spacing-2">
                            ...
                            <div class="testimonial-slide owl-carousel" data-item="1" data-nav="false"
                                    ...
                                    <div class="testimonial-content mb-35">
                                        <div class="testimonial-avatar">
                                            <div class="testimonial-img">
                                                <img class="img-center" src="{{ asset('public/asset/images/testimonial/01.jpg') }}"
                                                     alt="testimonial-img">
                                            </div>
                                        </div>
                                        ...
                                        <blockquote>Amazing service! Attention to detail, very helpful in terms of
                                            providing us with our preferred TV mounting and wiring needs. Excellent
                                            work and very pleasant! Highly recommend. Will hire again any time. Many
                                            thanks!
                                        </blockquote>
                                    </div>
                                ...
                                <div class="testimonials">
                                    <div class="testimonial-content mb-35">
                                        <div class="testimonial-avatar">
                                            <div class="testimonial-img">
                                                <img class="img-center" src="{{ asset('public/asset/images/testimonial/02.jpg') }}"
                                                     alt="testimonial-img">
                                            </div>
                                        </div>
                                        <div class="testimonial-caption">
                                        ...
                                        <blockquote>I called Boldman for some work. He arrived early, was very
                                            professional, went above and beyond to make sure that I was a happy
                                            client. I would definitely hire him again. He did a great job and I
                                ...
                                <div class="testimonials">
                                    <div class="testimonial-content mb-35">
                                        <div class="testimonial-avatar">
                                            <div class="testimonial-img">
                                                <img class="img-center" src="{{ asset('public/asset/images/testimonial/03.jpg') }}"
                                                     alt="testimonial-img">
                                            </div>
                                        </div>
                                        <div class="testimonial-caption">
                                        ...
                                        <blockquote>Boldman was awesome. Arrived early, super friendly, understood
                                            everything I needed. He finished his work on time, cleaned up the area
                                            and was professional. He did a great job and I would recommend him
                                            anytime.
                                        </blockquote>
                                    </div>
                                </div><!-- testimonials end -->
                                        ...
                                        <div class="ttm-fid-left">
                                            ...
                                            <h4 class="ttm-fid-inner">
                                                    <span data-appear-animation="animateDigits" data-from="0"
                                                          data-to="350" data-interval="5" data-before=""
                                                          data-before-style="sup" data-after=""
                                                          data-after-style="sub">350</span><span>+</span>
                                            </h4>
                                        </div>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    ...
                                    <div class="ttm-fid inside ttm-fid-view-lefticon">
                                        <div class="ttm-fid-left">
                                            ...
                                            <h4 class="ttm-fid-inner">
                                                    <span data-appear-animation="animateDigits" data-from="0"
                                                          data-to="120" data-interval="5" data-before=""
                                                          data-before-style="sup" data-after=""
                                                          data-after-style="sub">120</span><span>+</span>
                                            </h4>
                                        </div>
                                        <div class="ttm-fid-contents">
                                        ...
                                        <div class="ttm-fid-left">
                                            ...
                                            <h4 class="ttm-fid-inner">
                                                    <span data-appear-animation="animateDigits" data-from="0"
                                                          ...
                                                          data-before-style="sup" data-after=""
                                                          data-after-style="sub">30</span><span>+</span>
                                            </h4>
                                        </div>
                                        <div class="ttm-fid-contents">
                                    ...
                                    <div class="row multi-columns-row ttm-boxes-spacing-10px">
                                            ...
                                            <div class="featured-imagebox featured-imagebox-portfolio">
                                                ...
                                                <div class="featured-thumbnail">
                                                    <a href="#"> <img class="img-fluid"
                                                                      src="{{ asset('public/asset/images/portfolio/01.jpg') }}" alt="image"></a>
                                                    ...
                                                    <div class="ttm-box-view-content-inner">
                                                        <div class="featured-content featured-content-portfolio">
                                                            ...
                                                            <h2 class="featured-title"><a
                                                                    href="portfolio-style-1.html">Plumbing, New
                                                                    York</a></h2>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="ttm-box-col-wrapper col-lg-4 col-md-6 col-sm-12">
                                            ...
                                            <div class="featured-imagebox featured-imagebox-portfolio">
                                                ...
                                                <div class="featured-thumbnail">
                                                    <a href="#"> <img class="img-fluid"
                                                                      src="{{ asset('public/asset/images/portfolio/02.jpg') }}" alt="image"></a>
                                                </div><!-- featured-thumbnail end-->
                                                <!-- ttm-box-view-overlay -->
                                                <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                                    <div class="ttm-box-view-content-inner">
                                                        <div class="featured-content featured-content-portfolio">
                                                                <span class="category">
                                                                    <a href="portfolio-category.html">Tiles repair,
                                                                        Austin</a>
                                                                </span>
                                                            <h2 class="featured-title"><a
                                                                    href="portfolio-style-2.html">Home
                                                                    Maintenance</a></h2>
                                                        </div>
                                                    </div>
                                                </div><!-- ttm-box-view-overlay end-->
                                        ...
                                        <div class="ttm-box-col-wrapper col-lg-4 col-md-6 col-sm-12">
                                            ...
                                            <div class="featured-imagebox featured-imagebox-portfolio">
                                                ...
                                                <div class="featured-thumbnail">
                                                    <a href="#"> <img class="img-fluid"
                                                                      src="{{ asset('public/asset/images/portfolio/03.jpg') }}" alt="image"></a>
                                                </div><!-- featured-thumbnail end-->
                                                <!-- ttm-box-view-overlay -->
                                                <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                                    <div class="ttm-box-view-content-inner">
                                                        <div class="featured-content featured-content-portfolio">
                                                            ...
                                                            <h2 class="featured-title"><a
                                                                    href="portfolio-style-3.html">Floor Flooring,
                                                                    Bunnell</a></h2>
                                                        </div>
                                                    </div>
                                                </div><!-- ttm-box-view-overlay end-->
                                        ...
                                        <div class="ttm-box-col-wrapper col-lg-4 col-md-6 col-sm-12">
                                            ...
                                            <div class="featured-imagebox featured-imagebox-portfolio">
                                                ...
                                                <div class="featured-thumbnail">
                                                    <a href="#"> <img class="img-fluid"
                                                                      src="{{ asset('public/asset/images/portfolio/04.jpg') }}" alt="image"></a>
                                                </div><!-- featured-thumbnail end-->
                                                <!-- ttm-box-view-overlay -->
                                                <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                                    <div class="ttm-box-view-content-inner">
                                                        <div class="featured-content featured-content-portfolio">
                                                                <span class="category">
                                                                    <a href="portfolio-category.html">Flooring</a>,
                                                                    <a href="portfolio-category.html">Home
                                                                        Maintenance</a>
                                                                </span>
                                                            <h2 class="featured-title"><a
                                                                    href="portfolio-style-1.html">Drywall
                                                                    Insulation, Captown</a></h2>
                                                        </div>
                                                    </div>
                                                </div><!-- ttm-box-view-overlay end-->
                                            </div><!-- featured-imagebox -->
                                        ...
                                        <div class="ttm-box-col-wrapper col-lg-4 col-md-6 col-sm-12">
                                            ...
                                            <div class="featured-imagebox featured-imagebox-portfolio">
                                                ...
                                                <div class="featured-thumbnail">
                                                    <a href="#"> <img class="img-fluid"
                                                                      src="{{ asset('public/asset/images/portfolio/05.jpg') }}" alt="image"></a>
                                                </div><!-- featured-thumbnail end-->
                                                <!-- ttm-box-view-overlay -->
                                                <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                                    <div class="ttm-box-view-content-inner">
                                                        <div class="featured-content featured-content-portfolio">
                                                            ...
                                                            <h2 class="featured-title"><a
                                                                    href="portfolio-style-2.html">Electrical wiring,
                                                                    San Jose</a></h2>
                                                        </div>
                                                    </div>
                                                </div><!-- ttm-box-view-overlay end-->
                                        ...
                                        <div class="ttm-box-col-wrapper col-lg-4 col-md-6 col-sm-12">
                                            ...
                                            <div class="featured-imagebox featured-imagebox-portfolio">
                                                ...
                                                <div class="featured-thumbnail">
                                                    <a href="#"> <img class="img-fluid"
                                                                      src="{{ asset('public/asset/images/portfolio/06.jpg') }}" alt="image"></a>
                                                </div><!-- featured-thumbnail end -->
                                                <!-- ttm-box-view-overlay -->
                                                <div class="ttm-box-view-overlay ttm-portfolio-box-view-overlay">
                                                    <div class="ttm-box-view-content-inner">
                                                        <div class="featured-content featured-content-portfolio">
                                                            ...
                                                            <h2 class="featured-title"><a
                                                                    href="portfolio-style-3.html">Fireplace
                                                                    cleaning, Portland</a></h2>
                                                        </div>
                                                    </div>
                                                </div><!-- ttm-box-view-overlay end-->
                                            </div><!-- featured-imagebox -->
        ...
        <!--services-section-->
        <section
            class="ttm-row services-section bg-layer bg-layer-equal-height break-991-colum res-991-mt-0 clearfix">
            <div class="container">
                <!-- row -->
                <div class="row">
                    <div class="col-lg-8 col-md-12">
                        <!-- about-content -->
                        <div
                            class="about-content ttm-bg ttm-col-bgcolor-yes ttm-left-span ttm-bgcolor-darkgrey spacing-3">
                            <div class="ttm-col-wrapper-bg-layer ttm-bg-layer"></div>
                            <div class="layer-content">
                                <!-- section title -->
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <!--featured-icon-box-->
                                        <div
                                            class="featured-icon-box iconalign-before-heading ttm-icon_element-size-sm">
                                            <div class="featured-content">
                                                <div class="featured-icon">
                                                    <div
                                                        class="ttm-icon ttm-icon_element-color-skincolor ttm-icon_element-size-md">
                                            ...
                                            <a class="ttm-btn ttm-btn-size-sm ttm-icon-btn-right ttm-btn-color-white btn-inline mb-10"
                    ...
                    <div class="col-lg-4 col-md-12">
                        ...
                        <img src="{{ asset('public/asset/images/bg-image/col-bgimage-2.jpg') }}" class="ttm-equal-height-image" alt="bg-image">
                    </div>
                </div><!-- row end -->
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-9 col-md-12">
                        ...
                        <div class="section-title style2 clearfix">
                            ...
                            <div class="title-desc">Our people at Boldman are most valuable assets. They are the
                                faces of our organization.
                            </div>
                        </div><!-- section-title end -->
                    </div>
                    <div class="col-lg-3 col-md-12">
                        <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-icon-btn-right ttm-btn-style-border ttm-btn-color-white mt-15 mb-30 float-right res-991-mb-0"
                           href="#">VIEW MORE TEAM<i class="ti ti-angle-double-right"></i></a>
                    </div>
                </div><!-- row end -->
            </div>
        </section>
                ...
                <div class="row">
                    <div class="wrap-team team-slide owl-carousel" data-item="3" data-nav="false" data-dots="false"
                        ...
                        <div class="featured-imagebox featured-imagebox-team ttm-team-box-view-overlay">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="{{ asset('public/asset/images/team-member/team-img01.jpg') }}" alt="image">
                            </div>
                        ...
                        <div class="featured-imagebox featured-imagebox-team ttm-team-box-view-overlay">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="{{ asset('public/asset/images/team-member/team-img02.jpg') }}" alt="image">
                            </div>
                            <div class="featured-content featured-content-team">
                                <div class="featured-title">
                        ...
                        <div class="featured-imagebox featured-imagebox-team ttm-team-box-view-overlay">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="{{ asset('public/asset/images/team-member/team-img03.jpg') }}" alt="image">
                            </div>
                            <div class="featured-content featured-content-team">
                                <div class="featured-title">
                        ...
                        <div class="featured-imagebox featured-imagebox-team ttm-team-box-view-overlay">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="{{ asset('public/asset/images/team-member/team-img04.jpg') }}" alt="image">
                            </div>
                            <div class="featured-content featured-content-team">
                                <div class="featured-title">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-12">
                        <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-icon-btn-right ttm-btn-style-border ttm-btn-color-black mt-15 mb-30 float-right"
                           href="#">MORE NEWS<i class="ti ti-angle-double-right"></i></a>
                    </div>
                </div><!-- row end -->
                <!-- row -->
                <div class="row">
                    ...
                    <div class="post-slide owl-carousel owl-theme owl-loaded" data-item="3" data-nav="false"
                        ...
                        <div class="featured-imagebox featured-imagebox-post">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="{{ asset('public/asset/images/blog/01.jpg') }}" alt="">
                            </div>
                        ...
                        <div class="featured-imagebox featured-imagebox-post">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="{{ asset('public/asset/images/blog/02.jpg') }}" alt="">
                            </div>
                            <div class="featured-content featured-content-post">
                                <div class="post-meta">
                                        <span class="ttm-meta-line"><i class="fa fa-calendar"></i><a
                                                href="single-blog.html">January 31, 2019</a></span>
                                </div>
                                <div class="post-title featured-title">
                        ...
                        <div class="featured-imagebox featured-imagebox-post">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="{{ asset('public/asset/images/blog/03.jpg') }}" alt="">
                            </div>
                            <div class="featured-content featured-content-post">
                                <div class="post-meta">
                                        <span class="ttm-meta-line"><i class="fa fa-calendar"></i><a
                                                href="single-blog.html">February 5, 2019</a></span>
                                </div>
                                <div class="post-title featured-title">
                        ...
                        <div class="featured-imagebox featured-imagebox-post">
                            <div class="featured-thumbnail">
                                <img class="img-fluid" src="{{ asset('public/asset/images/blog/04.jpg') }}" alt="">
                            </div>
                            <div class="featured-content featured-content-post">
                                <div class="post-meta">
                                        <span class="ttm-meta-line"><i class="fa fa-calendar"></i><a
                                                href="single-blog.html">March 6, 2019</a></span>
                                </div>
                                <div class="post-title featured-title">
...
{{--                                <iframe src="https://www.youtube.com/embed/nKHiP7NH75E"--}}
...
{{--                                        allowfullscreen=""></iframe>--}}
                            ...
                            <div class="featured-content featured-content-post">
                                <div class="post-meta">
                                        <span class="ttm-meta-line"><i class="fa fa-calendar"></i><a
                                                href="single-blog.html">March 24, 2019</a></span>
                                </div>
                                <div class="post-title featured-title">
                                    <h5><a href="single-blog.html">Got a Leaking? Hire an experienced Plumber</a>
                                    </h5>
                                </div>
                            </div>
                        </div><!-- featured-imagebox-post end-->
